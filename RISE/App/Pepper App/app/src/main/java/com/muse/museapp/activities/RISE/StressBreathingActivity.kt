...
class StressBreathingActivity : RobotActivity(), RobotLifecycleCallbacks {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.stress_breathing_activity)
        setButtons()
        playAudio()
    }
    ...
    fun speak(qiContext: QiContext) {
        val speech: Say = SayBuilder.with(qiContext)
            .withText("Welcome to the Breathing module.     In this module, we'll be exploring the power of breathing.      Please take deep breaths in and out along the music.")
            .build()
        speech.run()
    }
