...
class GraQuiz : RobotActivity(), RobotLifecycleCallbacks {
...
//    private lateinit var countDownTimer: CountDownTimer
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.gra_quiz)
        pythonStart()
        ...
        question.text = "Click any Answer to Load/Begin Quiz\nThis may take a few seconds"
    }
    ...
    fun automaticTransition() {
        val intent = Intent(this, GraQuizResults::class.java)
        intent.putExtra("duration", duration)
        startActivity(intent)
    }

    override fun onRobotFocusGained(qiContext: QiContext){
        speak(qiContext, "Welcome to the quiz portions.           This quiz will test your knowledge on the module.            Click any answer to load and begin the quiz.")
    ...
    fun createQuiz() {
        ...
        val prompt = "Create 5 follow-up questions on genetic diseases and the process of genetic testing, make them difficult and thought-provoking, and dont make the correct answers obvious ensure they are only about colorectal cancer and genetic counseling. Please also make the questions and answers brief and write them for an audience with an 8th grade reading level. Make the five questions about the following topics: \\\"What are the main causes of colorectal cancer?\\\", \\\"What is genetic testing or what could possible results of genetic testing imply\\\", \\\"What are possible management options if the colorectal cancer is pathogenic or likely pathogenic?\\\", \\\"In what ways are my genetic rights protected by GINA?\\\", \\\"What the patient should do after receiving the results of their genetic testing\\\". Each question will begin formatted like this 'Q1:'. Give the correct answers to these questions after the question formatted to begin like so: 'Answer:'. Summarize the answers and keep them to less than 15 words. Do not have any other text other than questions and answers"
        ...
        answer1.setOnClickListener {
            ...
            if(currentQuestion == 5){
                ...
                nextButton.setOnClickListener {
                    ...
                    answer1.text = answers[currentQuestion*4]
                    answer2.text = answers[currentQuestion*4 + 1]
                    answer3.text = answers[currentQuestion*4 + 2]
                    answer4.text = answers[currentQuestion*4 + 3]
